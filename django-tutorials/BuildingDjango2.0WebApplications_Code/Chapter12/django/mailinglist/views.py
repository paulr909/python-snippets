...
from mailinglist.permissions import IsOwnerPermission
...
class MailingListRetrieveUpdateDetroyView(
...
class SubscriberListCreateView(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        mailing_list_id = self.kwargs['mailing_list_id']
        ...
        if kwargs.get('data'):
            ...
            mailing_list = {
                'mailing_list': reverse(
                    ...
                    kwargs={'pk': self.kwargs['mailing_list_id']})
            }
